...
if __name__ == '__main__':
	...
	hdf5_file.create_dataset("points_8", [num_items,batch_size_3,3], np.uint8)
	hdf5_file.create_dataset("values_8", [num_items,batch_size_3,1], np.uint8)
	...
	while True:
		...
		if item_flag:
			...
			hdf5_file["points_8"][idx,:,:] = sample_points_8
			hdf5_file["values_8"][idx,:,:] = sample_values_8
