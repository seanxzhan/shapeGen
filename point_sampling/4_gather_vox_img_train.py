...
vox_size = 16 # remember we sampled at 16x16x16 resolution in 2_gather...py
# batch_size_1 = 2*2*2 
# batch_size_2 = 4*4*4
...
hdf5_file.create_dataset("points_16", [num_shapes,batch_size_3,3], np.uint8, compression=9)
hdf5_file.create_dataset("values_16", [num_shapes,batch_size_3,1], np.uint8, compression=9)
